...
const LoginScreen = ({navigation}) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.ViewSignForget}>
        <Text style={styles.ViewForget}>Forget Password?</Text>
        <Text onPress={()=>navigation.navigate('SignUpScreen')} style={styles.ViewSignUp}>Sign Up</Text>
      </View>
    </View>
  );
};
